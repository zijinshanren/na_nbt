...
use crate::{
    ByteOrder, ConfigRef, Document, EMPTY_LIST, ImmutableConfig, Mark, NBT, Never, TypedListBase,
    TypedListRef, cold_path,
};
    ...
    for ReadonlyTypedList<'doc, O, D, T>
{
    ...
    #[inline]
    fn get(&self, index: usize) -> Option<<T>::TypeRef<'doc, Self::Config>> {
        self.get(index)
    }
