...
use crate::{
    ByteOrder, IntoNBT, MutVec, MutableConfig, NBT, RefTypedListIter, TypedListBase, TypedListMut,
...
impl<'s, O: ByteOrder, T: NBT> MutTypedList<'s, O, T> {
    ...
    #[inline]
    pub fn push(&mut self, value: impl IntoNBT<O, Tag = T>) -> Option<T::Type<O>> {
    ...
    #[inline]
    pub fn insert(&mut self, index: usize, value: impl IntoNBT<O, Tag = T>) -> Option<T::Type<O>> {
